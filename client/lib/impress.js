    ...
    function ($compile) {
        ...
        return {
            ...
            controller: function ($scope, $element) {
                ...
                $scope.$on('initImpress', function (event,args) {
                    $scope.slides = $($element).find('.step');
               /*     var meta = $('meta[name="viewport"]') || document.createElement('meta');
                   ...
                   $scope.canvas.append($element.children('.step'));
                    ...
                    //Signal for impress inizialized
                    //console.log("inited",$scope.$emit('impressInited'));
                    $scope.currentSlide = args;
                    $scope.goToSlide();
                });

                $scope.goToSlide = function (index) {
                    console.log("goToSlide",$scope.currentSlide);
                    window.scrollTo(0, 0);
                    if (!index) {
